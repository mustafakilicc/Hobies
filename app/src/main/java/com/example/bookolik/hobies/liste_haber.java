...
public class liste_haber extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "http://echooffuture.com/Subjects_haber.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(liste_haber.this).execute();
    }
