...
public class liste_kultur extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "http://echooffuture.com/Subjects_kultur.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(liste_kultur.this).execute();
    }
