...
public class liste_bilim extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "http://echooffuture.com/Subjects_bilim.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(liste_bilim.this).execute();
    }
