...
public class liste_dizi_film extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "http://echooffuture.com/Subjects_dizi_film.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(liste_dizi_film.this).execute();
    }
