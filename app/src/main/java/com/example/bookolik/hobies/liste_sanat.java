...
public class liste_sanat extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "http://echooffuture.com/Subjects_sanat.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(liste_sanat.this).execute();
    }
